---
description: Point at the relevant E2E.md checklist section for a given flow, and list which automated tests already cover it.
argument-hint: <flow name, e.g. "booking", "matching", "Google OAuth">
---
