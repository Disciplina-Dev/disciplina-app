---
description: Read-only performance review of the current diff (vs main) — N+1 queries, missing indexes, unnecessary React memoization, bundle bloat, redundant urql queries. Use before merging, or when explicitly asked for a perf pass.
mode: subagent
permission:
  edit: deny
---
