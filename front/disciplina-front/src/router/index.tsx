...
import FicheEntreprise from "@/pages/commercial/FicheEntreprise";
import NouvelleEntreprise from "@/pages/commercial/NouvelleEntreprise";
import Relances from "@/pages/commercial/Relances";
...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "portefeuille/nouvelle", element: <NouvelleEntreprise /> },
      { path: "portefeuille/:id", element: <FicheEntreprise /> },
      { path: "relances", element: <Relances /> },
    ],
  },
  {
    path: "/rh",
