        ...
        fields: [
            {
                ...
                type: 'text',
                role: SIGNER_ROLE,
                areas: [{ page: 1, x: 0.43, y: 0.232, w: 0.44, h: 0.016 }],
            },
            {
                name: 'Dénomination ou raison sociale',
                type: 'text',
                role: SIGNER_ROLE,
                areas: [{ page: 1, x: 0.45, y: 0.249, w: 0.42, h: 0.016 }],
            },
            {
                name: 'Numéro de SIRET',
                type: 'text',
                role: SIGNER_ROLE,
                areas: [{ page: 1, x: 0.28, y: 0.267, w: 0.45, h: 0.016 }],
            },
            {
                name: 'Adresse du siège',
                type: 'text',
                role: SIGNER_ROLE,
                areas: [{ page: 1, x: 0.28, y: 0.283, w: 0.45, h: 0.016 }],
            },
            {
                name: 'Code APE',
                type: 'text',
                role: SIGNER_ROLE,
                areas: [{ page: 1, x: 0.24, y: 0.299, w: 0.45, h: 0.016 }],
            },
            {
                name: 'Fait à',
                type: 'text',
