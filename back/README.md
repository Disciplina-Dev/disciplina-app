...
src/
  ...
  rest/                 21 feature modules + middleware/ + shared/
    ...
    external/           Guest magic-link flows for candidates / companies (cookie `disc_at`, no code, 7 days after first open; ref 1 CV import, ref 2 matching, ref 3 interview slots)
